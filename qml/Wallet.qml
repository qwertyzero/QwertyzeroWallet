...
Rectangle {
    ...
    Rectangle {
        ...
        Text {
            ...
            color: "#858585"
            text: "Copy your address to receive QWCZ"
    ...
    Rectangle {
        ...
        Button {
            ...
            onClicked: {
                ...
                dialogConfirmTransfer.show(rectangleTransfer.transferRecipient, rectangleTransfer.transferAmount + " QWCZ + " + rectangleTransfer.transferFee + " (fee) + " + rectangleTransfer.nodeFeeValue + " (node fee)", rectangleTransfer.transferPaymentID);
            }
        }
